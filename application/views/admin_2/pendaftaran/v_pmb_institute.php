            ...
            <table id="inbox" class="ui celled table" style=" width:100%; padding:0px;">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      switch($s->prodi){
                        case '1':
                            echo "<td class='bold'>PAI - Pendidikan Agama Islam</td>";
                        break;
                        case '2':
                            echo "<td class='bold'>PAI & IAT (Double Gelar)</td>";
                        break;
                        default:
                            echo "<td class='bold'>PAI & IAT (Double Gelar)</td>";
                        break;
                      ...
                      ?>
                        ...
                        <td>
                            <a href="<?=base_url('admin_dua/detail_pmb_institute/') . $s->id_pmb ?>"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin_dua/konfirmasi_institute/'. $s->id_pmb) ?>">
                        <div class=" mb-2">
                            <label for="exampleFormControlInput1" class="form-label bold">Program Studi :</label>
