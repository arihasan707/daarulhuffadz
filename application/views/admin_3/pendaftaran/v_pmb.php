                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                                    switch($s->kelas){
                                        case "1";
                                        echo "<span class='bold'>Kutab Tahfidz Online</span><br>(Tingkat SD)";
                                        break;
                                        case "2";
                                        echo "<span class='bold'>Madrasah Tahfidz Online</span><br>(Tingkat SMP & SMA)";
                                        break;
                                        case "3";
                                        echo "<span class='bold'>Tahsin Online Reguler</span><br>(3x Pertemuan perpekan)";
                                        break;
                                        case "4";
                                        echo "<span class='bold'>Tahsin Online Intensif</span><br>(6x Pertemuan perpekan)";
                                        break;
                                        case "5";
                                        echo "<span class='bold'>Tahfidz Online Reguler</span><br>(3x Pertemuan perpekan)";
                                        break;
                                        case "6";
                                        echo "<span class='bold'>Tahfidz Online Intensif</span><br>(6x Pertemuan perpekan)";
                                        break;
                                        }
                                    ?>
                        </td>
